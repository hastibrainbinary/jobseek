                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      child: Text(args['fullName'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                      ),
                      // const SizedBox(height: 10),
                      // commonTextFormField(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: ColorRes.containerColor)),
                        child: Text(args['Email'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                      ),
                      // commonTextFormField(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: ColorRes.containerColor)),
                        child: Text(args['Phone'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                      ),
                      // Container(
                      //   height: 50,
                      //   decoration: BoxDecoration(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: ColorRes.containerColor)),
                        child: Text(args['City'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                      ),
                      // commonTextFormField(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: ColorRes.containerColor)),
                        child: Text(args['State'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                      ),
                      // commonTextFormField(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: ColorRes.containerColor)),
                        child: Text(args['Country'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                      ),
                      // commonTextFormField(
