            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("What are you looking for?",style: appTextStyle(color: ColorRes.black),),
                  const SizedBox(height: 30,),
                  Padding(
                      ...
                      children: [
                        InkWell(
                          onTap:()=> controller.onChangeWantJobChoice(),
                            child:Obx(() => lookingForYouBox(AssetRes.wantJob,"I want job",controller.isJob.value)) ),
                        InkWell(
                          onTap: ()=>controller.onChangeEmployeeChoice(),
                            child:Obx(() => lookingForYouBox(AssetRes.person,"I want an employee",controller.isEmployee.value)) ),
                      ],
                    ),
                  )
