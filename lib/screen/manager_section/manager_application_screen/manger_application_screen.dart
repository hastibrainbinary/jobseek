            ...
            builder: (context) {
              return StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  controller.documentData = controller.documentData.where((element) {

                    print(element.get("Position").toString()
                        .toLowerCase()
                    ...
                    child: (snapshot.data == null)
                        ...
                        builder: (con) {
                          return (controller.isData == true)
                            ...
                            itemBuilder:
                                (context, index) {
                              if (controller.documentData[index]
                              ["Status"] ==
                                  "Active") {
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(controller.documentData[index]["type"],
                                                    style: appTextStyle(color: ColorRes.black, fontSize: 10, fontWeight: FontWeight.w400)),
                                              ],
                                            ),
                                          ],
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration:
                                              BoxDecoration(
                                                color: controller.documentData[index]["Status"] == "Active"
                                                    ? ColorRes.lightGreen
                                              ...
                                              Text(
                                                ...
                                                style:
                                                appTextStyle(color: controller.documentData[index]["Status"] == "Active" ? ColorRes.darkGreen : ColorRes.starColor, fontSize: 12),
                                              ),
                                            ),
                                            const Spacer(),
                                            Text(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(controller.documentData[index]["Position"],
                                                style: appTextStyle(color: ColorRes.black, fontSize: 15, fontWeight: FontWeight.w500)),
                                            Text(controller.documentData[index]["CompanyName"],
