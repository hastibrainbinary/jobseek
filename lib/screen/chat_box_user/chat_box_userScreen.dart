    ...
    return Scaffold(
      ...
      body: Column(children: [
       ...
       GetBuilder<ChatBoxUserController>(
         id: "searchChat",
         builder: (controller) {
         return   controller.selectedJobs.value == 0 ?   GetBuilder<ChatBoxUserController>(
             id: "searchChat",
             builder: (controller) {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(
                                controller.dataChatUser[index]["lastMessage"],
                                style: appTextStyle(
                                    color: ColorRes.black.withOpacity(0.8),
                                    fontSize: 12,
                                    fontWeight: FontWeight.w400),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              Text(
                                getFormattedTime(controller.dataChatUser[index]
                                ["time"]
                                    .toDate())
                                    .toString(),
                                style: appTextStyle(
